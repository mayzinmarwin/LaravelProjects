...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <img src="{{asset('asonemart/images/asonemart_logo.png')}}" alt="AdminLTE Logo" class="brand-image elevation-3">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                ...
                <img src="{{ asset('/uploads/user/'. Auth::user()->photo)}}"  height="60px;" srcset="" alt=""> 
            ...
            <!-- Add icons to the links using the .nav-icon class
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{route('main_category.index')}}" class="nav-link">
                ...
                @endif
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('logout') }}" onclick="event.preventDefault();confirm('Are You Sure Logout.') && document.getElementById('logout-form').submit();">
   ...
   <div class="content-wrapper">
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2022 <a href="#">Ecommerce</a>.</strong>
        All rights reserved.
        <div class="float-right d-none d-sm-inline-block">
        <b>Developed</b> By MZMW
        </div>
    </footer>
    <!-- Control Sidebar -->
...
<script src="{{asset('admin/js/demo.j')}}s"></script> --}}
