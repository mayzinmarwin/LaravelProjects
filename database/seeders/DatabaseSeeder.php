...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
       ...
       // Vendor::truncate();
        ...
        DB::table('sub_category_products')->truncate();
        ...
        DB::table('product_writers')->truncate();
        DB::table('product_publications')->truncate();
        ...
        for ($i = 0; $i < 20; $i++) {
            ...
            DB::table('main_category_products')->insert(
            ...
            DB::table('product_writers')->insert([
                ['writer_id' => 1, 'product_id' => $product->id],
                ['writer_id' => 2, 'product_id' => $product->id],
            ]);

            DB::table('product_publications')->insert([
